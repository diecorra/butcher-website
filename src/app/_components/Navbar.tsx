      ...
      <div className="container px-8 flex justify-between items-center">
        <div className="flex gap-5 items-center">
          <Link href={igLink} aria-label="Instagram" target="_blank">
            <RiInstagramFill className="naviconElements hidden lg:block icon hover:fill-orange-600" />
          </Link>
          <Link href={fbLink} aria-label="Facebook" target="_blank">
            <FaSquareFacebook className="naviconElements icon hidden lg:block hover:fill-orange-600" />
          </Link>
          <Link
            ...
            target="_blank"
          >
            <IoLogoWhatsapp className="naviconElements icon hidden lg:block hover:fill-orange-600" />
          </Link>
          <Link href={placeLink} aria-label="Google Maps" target="_blank">
            <MdPlace className="naviconElements icon hidden lg:block hover:fill-orange-600" />
          </Link>
        </div>
